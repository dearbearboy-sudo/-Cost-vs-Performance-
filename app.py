...
# ส่วนที่ 1: ดึงราคาและคำนวณต้นทุนฟิล์มต่อ m2 แบบถูกต้อง
for i in range(int(num_layers)):
    ...
    # แก้ไขสูตรตรงนี้: หนา (µm) x Density (g/cm³) x (ราคาต่อกก. / 1000) เพื่อแปลงเป็น บาท/ตร.ม.
    film_cost_m2 = actual_thickness * density * (price_per_kg / 1000)
...
# ส่วนที่ 3: คำนวณตามสูตรพ่วงด้วย Variable Cost 15%
...
# ตารางแจกแจงโครงสร้างภายใน (ไม่โชว์ราคารายชั้นเหมือนเดิม)
